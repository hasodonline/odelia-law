/*
 * ============================================
 *  קובץ הגדרות האתר - עורכת דין אודליה
...
const SITE_CONFIG = {
  ...
  // === פרטים אישיים ===
  lawyerName: "אודליה אייזנקייט",              // שם מלא
  ...
  // === SEO ===
  siteTitle: "עו\"ד אודליה כהן | דיני משפחה, גישור, צוואות וליווי משפטי",
  siteDescription: "עורכת דין אודליה כהן – משרד עורכי דין המתמחה בדיני משפחה, גישור, ייפוי כוח מתמשך, צוואות וירושות, דיני חברות וליווי משפטי מקיף ליחידים ולעסקים.",
