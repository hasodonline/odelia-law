/*
 * ============================================
 *  קובץ הגדרות האתר - עורכת דין אודיה
 *  ערכי/ערכי את הפרטים למטה בלבד
 * ============================================
 */
...
const SITE_CONFIG = {
  ...
  // === פרטים אישיים ===
  lawyerName: "אודיה אייזנקייט",              // שם מלא
  lawyerTitle: "עו\"ד ומגשרת",            // תואר מקצועי
  ...
  // === פרטי קשר ===
  phone: "050-2899933",                   // טלפון נייד
  phoneLink: "tel:+9720502899933",        // לינק לטלפון (שנה את המספר)
  whatsapp: "https://wa.me/9720502899933", // לינק לוואטסאפ
  email: "lawodelia@gmail.com",         // אימייל

  // === כתובת המשרד ===
  officeAddress: "רחוב ארלוזרוב 17", // כתובת
  officeCity: "הוד השרון",                 // עיר
  ...
  // === SEO ===
  siteTitle: "עו\"ד אודיה אייזנקייט | דיני משפחה, גישור, צוואות וליווי משפטי",
  siteDescription: "עורכת דין אודיה אייזנקייט – משרד עורכי דין המתמחה בדיני משפחה, גישור, ייפוי כוח מתמשך, צוואות וירושות, דיני חברות וליווי משפטי מקיף ליחידים ולעסקים.",
